...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($name)) {
        ...
        $sql = "INSERT INTO `tb_category` (`name`, `description`, `teacher_id`) VALUES ('$name','$description', $user_id)";
            ...
            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                <div class="box box-success">
                    <div class="box-header with-border">
                        <h4 class="box-title">Add your category</h4>
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control input-lg" name="name" value="<?=htmlspecialchars($name)?>" placeholder="Enter Category">
                        </div>
                        <div class="form-group">
                ...
                <div class="box box-solid">
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-12">
                                <span class="pull-left" style="font-size: xx-large">Click <b>[Save]</b> to add Category</span>
...
if ($statusSuccess) {
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $("#modal-success-add-category").modal('show');
        });
    </script>
    <div class="modal fade" id="modal-success-add-category" role="dialog" data-keyboard="false" data-backdrop="static">
        <div class="modal-dialog modal-dialog-scrollable modal-md" role="document">
            <div class="modal-content">
                <div class="modal-body text-center">
                    ...
                    <h3 class="text-info">Add Category Successfully</h3>
                    <br/><br/>
