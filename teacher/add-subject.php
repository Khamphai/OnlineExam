...
$msg = "";
$statusSuccess = false;
$title = $description = $use_count = $level = "";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($title)) {
        ...
        $sql = "INSERT INTO `tb_subjects` (`title`, `description`, `level`, `give_minute`, `pass_percent`, `use_count`, `status`, `cat_id`, `teacher_id`) VALUES ('$title','$description', $level, $give_minute, $pass_percent, $use_count, $status, $cat_id, $user_id)";
            ...
            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                <div class="box box-success">
                    <div class="box-header with-border">
                        <h4 class="box-title">Add your subject</h4>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <span class="pull-left"
                                      style="font-size: xx-large">Click <b>[Save]</b> to add Subject</span>
...
if ($statusSuccess) {
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $("#modal-success-add-subject").modal('show');
        });
    </script>
    <div class="modal fade" id="modal-success-add-subject" role="dialog" data-keyboard="false" data-backdrop="static">
        <div class="modal-dialog modal-dialog-scrollable modal-md" role="document">
            <div class="modal-content">
                <div class="modal-body text-center">
                    ...
                    <h3 class="text-info">Add Subject Successfully</h3>
                    <br/><br/>
